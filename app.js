...
function calculateSalary(){
	...
	gross_salary = parseFloat(document.getElementById('gross_salary').value).toFixed(2);
	...
	result = document.getElementById("result").innerHTML = "ሙሉ ደመወዝ | Gross Salary= " + gross_salary + " ETB"
													+"<br/>"+"የገቢ ታክስ | Income Tax = " + income_tax.toFixed(2) + " ETB"
														+"<br/>"+"ጡረታ | Pension = " + pension + " ETB"
														+"<br/>"+"ደራሽ ደመወዝ | Net Salary = " + net_salary + " ETB";
